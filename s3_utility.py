...
class S3Utility(object):
	...
	This is a class rather than a module because some state is required to avoid having to reestablish an s3 connection each transaction.
	...
	def download_file_list(self, s3_bucket, prefix=''):
		"""
		:description: loads the name of the files in a bucket. Optionally returns only those filenames that start with prefix.
		"""
